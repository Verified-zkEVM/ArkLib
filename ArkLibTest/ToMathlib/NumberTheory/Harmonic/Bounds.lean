...
threshold `8 ≤ n` in `Real.reciprocal_square_sum_gt`. For the square-root comparison: its value
at `x = 48000`, its equality case `x = x₀`, and the case showing that `exp 2 ≤ x₀` is needed.
-/
