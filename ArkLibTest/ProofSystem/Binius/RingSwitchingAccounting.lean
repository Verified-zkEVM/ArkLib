...
/-!
# Actual GF16 ring-switching challenge-error accounting
...
/-- The actual full-family pipeline has one batching and two tail challenge indices. -/
...
/-- The extra deterministic scalar head leaves the actual challenge count unchanged. -/
...
/-- Sum the production error function used by the actual GF16 Binius pipeline. -/
