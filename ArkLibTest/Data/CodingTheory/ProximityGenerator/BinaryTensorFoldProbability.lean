...
example (u : (Fin 3 → Bool) → Fin 2 → ZMod 3) :
    Pr_{let r ←$ᵖ (Fin 3 → ZMod 3)}[r ∈ tensorFoldBad fullCode_level u] = 0 :=
...
example (u : (Fin 3 → Bool) → Fin 2 → ZMod 3) :
    Pr_{let r ←$ᵖ (Fin 3 → ZMod 3)}[¬ HasFullTensorDecomposition fullCode 2 r u] = 0 :=
...
example {C : ModuleCode (Fin 2) (ZMod 3) (ZMod 3)} {a e : ℕ} (h : FullSetLevelWitness C a e)
    ...
    Pr_{let r ←$ᵖ (Fin 0 → ZMod 3)}[r ∈ tensorFoldBad h u] = 0 :=
...
example {ι F A : Type} [Fintype ι] [DecidableEq ι] [Field F] [Fintype F]
...
example {C : ModuleCode (Fin 2) (ZMod 3) (ZMod 3)} {a e : ℕ} (h : FullSetLevelWitness C a e)
    ...
    Pr_{let r ←$ᵖ (Fin 2 → ZMod 3)}[r ∈ tensorFoldFamilyBad h u] ≤
...
example {C : ModuleCode (Fin 2) (ZMod 3) (ZMod 3)} {a e : ℕ} (h : FullSetLevelWitness C a e)
    ...
    Pr_{let r ←$ᵖ (Fin 3 → ZMod 3)}[r ∈ tensorFoldBad (h.moduleInterleavedCode (κ := Fin 5)) u] ≤
