...
% \lean{Folding.exists_unique_bivariate,Folding.degree_bound_bivariate}  % TODO: not yet formalized in ArkLib; relink when the bivariate-decomposition facts land
...
% \lean{Folding.fold}  % TODO: function-folding operator not yet formalized in ArkLib; relink when it lands
...
% \lean{Folding.folding}  % TODO: folding distance-preservation lemma not yet formalized in ArkLib; relink when it lands
