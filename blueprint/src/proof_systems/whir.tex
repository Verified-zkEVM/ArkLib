...
\uses{def:block_rel_distance,def:dist_from_code,def:list_close_codewords_block,def:list_close_codewords}
...
\lean{BlockRelDistance.folding_listdecoding_if_genMutualCorrAgreement}
...
\lean{BlockRelDistance.folding_preserves_listdecoding_base}
...
\lean{BlockRelDistance.folding_preserves_listdecoding_bound}
...
\lean{BlockRelDistance.folding_preserves_listdecoding_base_ne_subset}
\uses{def:list_close_codewords_block,def:fold_k,def:fold_k_set}
    \[
    \Pr_{\alpha \leftarrow \field} \left[
...
\uses{thm:folding_preserves_listdecoding,lemma:out_of_domain_sampling_crs_eq_rs,lemma:gen_mutual_corr_agreement}
