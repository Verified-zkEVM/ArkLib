...
\begin{definition}\label{def:proximity_generator}
    % \lean{Generator.ProximityGenerator} % TODO: declaration is not currently formalized.
...
\begin{theorem}\label{thm:proximity_gap_whir}
    % \lean{RSGenerator.genRSC} % TODO: declaration is not currently formalized.
...
\begin{definition}\label{def:gen_mutual_corr_agreement}
    % \lean{MutualCorrAgreement.hasMutualCorrAgreement} % TODO: declaration is not currently formalized.
...
\begin{lemma}\label{lemma:gen_mutual_corr_agreement}
    % \lean{MutualCorrAgreement.mca_linearCode} % TODO: declaration is not currently formalized.
...
\begin{lemma}
    % \lean{MutualCorrAgreement.mca_rsc} % TODO: declaration is not currently formalized.
...
\begin{theorem}\label{conjecture:whir}
    % \lean{MutualCorrAgreement.mca_johnson_bound_CONJECTURE,MutualCorrAgreement.mca_capacity_bound_CONJECTURE} % TODO: declarations are not currently formalized.
...
\begin{lemma}\label{lemma: mutual_corrAgr_listdecoding}
    % \lean{MutualCorrAgreement.mca_list_decoding} % TODO: declaration is not currently formalized.
...
\begin{definition}\label{def:extract}
    % \lean{Fold.extract_x} % TODO: declaration is not currently formalized.
...
\begin{definition}\label{def:foldf}
    % \lean{Fold.foldf} % TODO: declaration is not currently formalized.
\uses{def:extract}
...
\begin{definition}\label{def:fold_k}
    % \lean{Fold.fold_k_core,Fold.fold_k} % TODO: declarations are not currently formalized.
\uses{def:foldf}
...
\begin{definition}\label{def:fold_k_set}
    % \lean{Fold.fold_k_set} % TODO: declaration is not currently formalized.
\uses{def:fold_k}
...
\begin{lemma}\label{lemma:fold_fg}
    % \lean{Fold.fold_f_g} % TODO: declaration is not currently formalized.
...
\begin{definition}\label{def:block}
    % \lean{BlockRelDistance.block} % TODO: declaration is not currently formalized.
...
\begin{definition}\label{def:min_block_rel_distance}
    % \lean{BlockRelDistance.minBlockRelDistance} % TODO: declaration is not currently formalized.
...
\begin{definition}\label{def:list_close_codewords_block}
    % \lean{BlockRelDistance.listBlockRelDistance} % TODO: declaration is not currently formalized.
\uses{def:block_rel_distance}
...
\begin{theorem}\label{thm:folding_preserves_listdecoding}
    % \lean{Fold.folding_listdecoding_if_genMutualCorrAgreement} % TODO: theorem is not currently formalized.
...
\begin{lemma}\label{lemma:folding_preserves_listdecoding_base}
    % \lean{Fold.folding_preserves_listdecoding_base} % TODO: lemma is not currently formalized.
...
\begin{lemma}\label{lemma:folding_preserves_listdecoding_bound}
    % \lean{Fold.folding_preserves_listdecoding_bound} % TODO: lemma is not currently formalized.
...
\begin{lemma}\label{lemma:folding_preserves_listdecoding_base_ne_subset}
    % \lean{Fold.folding_preserves_listdecoding_base_ne_subset} % TODO: lemma is not currently formalized.
\uses{def:list_close_codewords_block,def:fold_k,def:fold_k_set}
    \[
    \Pr_{\alpha \leftarrow \field} \left[
...
\begin{theorem}\label{thm: whir_rbr_soundness}
    % \lean{WhirIOP.whir_rbr_soundness} % TODO: theorem is not currently formalized.
