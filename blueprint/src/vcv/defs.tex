...
These are stated as ordinary instance hypotheses quantified over the oracle index, on \verb|spec.Domain t| and \verb|spec.Range t|, rather than as bundled classes on the specification.
...
\begin{definition}[Oracle Computation]
    ...
    \end{itemize}
    The formal implementation uses a free monad on the inductive type of oracle queries \lean{OracleQuery} wrapped in an option monad transformer (i.e. \verb|OptionT(FreeMonad(OracleQuery spec))|).
    \lean{OracleComp}
