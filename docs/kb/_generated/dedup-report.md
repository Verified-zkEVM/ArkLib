...
- `ArkLib` — 273 files, 4709 declarations
...
- `abbrev Domain.CosetFftDomain.subdomain` [ArkLib/Data/Domain/CosetFftDomain/Subdomain.lean:460](../../../ArkLib/Data/Domain/CosetFftDomain/Subdomain.lean#L460) — Concrete notation for taking the `i`th subdomain of a smooth coset FFT domain.
...
- `lemma Domain.CosetFftDomain.mem_toFinset_iff_mem` [ArkLib/Data/Domain/CosetFftDomain/Mem.lean:134](../../../ArkLib/Data/Domain/CosetFftDomain/Mem.lean#L134) — Membership in the finset of elements is the same as membership in the concrete coset FFT domain.
- `lemma Domain.FftDomain.mem_toFinset_iff_mem` [ArkLib/Data/Domain/FftDomain/Mem.lean:80](../../../ArkLib/Data/Domain/FftDomain/Mem.lean#L80) — Membership in the finset of elements is the same as membership in the FFT domain.
