...
- `ArkLib` — 324 files, 5512 declarations
...
- `abbrev Domain.CosetFftDomain.subdomain` [ArkLib/Data/Domain/CosetFftDomain/Subdomain.lean:515](../../../ArkLib/Data/Domain/CosetFftDomain/Subdomain.lean#L515) — Concrete notation for taking the `i`th subdomain of a smooth coset FFT domain.
