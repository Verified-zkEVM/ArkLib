...
- `ArkLib` — 318 files, 5154 declarations

## Same short-name across multiple files (165 groups)

Each group lists declarations sharing a short name across ≥2 files. Most are legitimate (overloaded interface, paper-shape vs general form), but the list is the right anchor to look for duplicates.

### `verifier` (12 declarations, 10 files)

- `def ArkLib.Lattices.Ajtai.InnerOuter.verifier` [ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean:345](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean#L345) — The reduction's verifier (Hachi §4.2, Figure 3) is a **pure pass-through**: it re-emits the statemen
- `def CoordinateWise.CommittedScalar.verifier` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean:102](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean#L102) — Pure statement-extending verifier shared by committed scalar phases.
...
- `def ReduceClaim.verifier` [ArkLib/ProofSystem/Component/ReduceClaim.lean:53](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L53) — The verifier for the `ReduceClaim` reduction.
- `def SendWitness.verifier` [ArkLib/ProofSystem/Component/SendWitness.lean:71](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L71) — (no docstring)
- `def RingSwitching.QuotientEval.verifier` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:119](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L119) — The switch's pure statement-extending verifier, from the committed-scalar shell.
...
- `def CheckClaim.oracleVerifier` [ArkLib/ProofSystem/Component/CheckClaim.lean:190](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L190) — The oracle verifier for the `CheckClaim` oracle reduction is a **pure pass-through**: it returns the
...
- `def ReduceClaim.oracleVerifier` [ArkLib/ProofSystem/Component/ReduceClaim.lean:229](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L229) — The oracle verifier for the `ReduceClaim` oracle reduction.
...
- `def SendSingleWitness.oracleVerifier` [ArkLib/ProofSystem/Component/SendWitness.lean:271](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L271) — The oracle verifier for the `SendSingleWitness` oracle reduction. The verifier receives the input st
- `def RingSwitching.BatchingPhase.oracleVerifier` [ArkLib/ProofSystem/RingSwitching/TensorPacking/BatchingPhase.lean:143](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/BatchingPhase.lean#L143) — The batching-phase verifier as an instance of the family-shared check-then-update scalar-round verif
...
- `def CheckClaim.oracleReduction` [ArkLib/ProofSystem/Component/CheckClaim.lean:198](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L198) — The oracle reduction for the `CheckClaim` oracle reduction.
...
- `def ReduceClaim.oracleReduction` [ArkLib/ProofSystem/Component/ReduceClaim.lean:235](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L235) — The oracle reduction for the `ReduceClaim` oracle reduction.
...
- `def SendSingleWitness.oracleReduction` [ArkLib/ProofSystem/Component/SendWitness.lean:284](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L284) — (no docstring)
...
- `def ArkLib.Lattices.Ajtai.InnerOuter.prover` [ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean:359](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean#L359) — The honest prover (Hachi §4.2, Figure 3; completeness is out of scope for Lemma 8): round 0 sends th
- `def CoordinateWise.CommittedScalar.prover` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean:112](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean#L112) — Honest prover shell for a committed scalar phase. The commitment is derived from `computeW`; the API
...
- `def ReduceClaim.prover` [ArkLib/ProofSystem/Component/ReduceClaim.lean:45](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L45) — The prover for the `ReduceClaim` reduction.
- `def SendWitness.prover` [ArkLib/ProofSystem/Component/SendWitness.lean:61](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L61) — (no docstring)
- `def RingSwitching.QuotientEval.prover` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:125](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L125) — Honest prover shell. Its commitment is definitionally derived from the output opening.
...
- `def ReduceClaim.reduction` [ArkLib/ProofSystem/Component/ReduceClaim.lean:57](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L57) — The reduction for the `ReduceClaim` reduction.
- `def SendWitness.reduction` [ArkLib/ProofSystem/Component/SendWitness.lean:75](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L75) — (no docstring)
...
- `def CoordinateWise.SingleRound.pSpec` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:51](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L51) — The two-round single-challenge-round protocol (instantiated by Hachi's `QuadEval` reduction): the pr
...
- `def CheckClaim.oracleProver` [ArkLib/ProofSystem/Component/CheckClaim.lean:175](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L175) — The oracle prover for the `CheckClaim` oracle reduction: it forwards the statement and all oracle st
...
- `def ReduceClaim.oracleProver` [ArkLib/ProofSystem/Component/ReduceClaim.lean:219](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L219) — The oracle prover for the `ReduceClaim` oracle reduction.
...
- `def SendWitness.oracleProver` [ArkLib/ProofSystem/Component/SendWitness.lean:162](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L162) — The oracle prover for the `SendWitness` oracle reduction. For each round `i : Fin (FinEnum.card ιw)`
- `def SendSingleWitness.oracleProver` [ArkLib/ProofSystem/Component/SendWitness.lean:255](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L255) — The oracle prover for the `SendSingleWitness` oracle reduction. The prover sends the witness `wit` t
- `def RingSwitching.BatchingPhase.oracleProver` [ArkLib/ProofSystem/RingSwitching/TensorPacking/BatchingPhase.lean:90](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/BatchingPhase.lean#L90) — (no docstring)
...
- `theorem ReduceClaim.oracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Component/ReduceClaim.lean:366](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L366) — The `ReduceClaim` oracle reduction satisfies perfect round-by-round knowledge soundness. Note that s
...
- `def CoordinateWise.GCWSSPackage.append` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/Guarded.lean:196](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/Guarded.lean#L196) — **Compose two guarded packages along a matching seam** (`hseam` discharged by `rfl`): the guarded an
- `def CoordinateWise.CWSSPackage.append` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/Package.lean:79](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/Package.lean#L79) — **Compose two packages along a matching seam.** Given a left package `L₁ : relIn ⇒ mid`, a right pac
...
- `instance CheckClaim.instIsPure` [ArkLib/ProofSystem/Component/CheckClaim.lean:219](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L219) — The `CheckClaim` oracle verifier is pure: its underlying verifier deterministically returns the comb
- `instance ReduceClaim.instIsPure` [ArkLib/ProofSystem/Component/ReduceClaim.lean:178](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L178) — The `ReduceClaim` verifier is pure: it deterministically returns `mapStmt stmt`. This discharges the
...
- `instance SendWitness.instIsPure` [ArkLib/ProofSystem/Component/SendWitness.lean:90](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L90) — The `SendWitness` verifier is pure: it deterministically returns `⟨stmt, transcript 0⟩`. This discha
- `instance SendSingleWitness.instIsPure` [ArkLib/ProofSystem/Component/SendWitness.lean:324](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L324) — The `SendSingleWitness` oracle verifier is pure: its underlying (non-oracle) verifier deterministica

### `Statement` (5 declarations, 5 files)

- `abbrev CoordinateWise.CommittedScalar.Statement` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean:90](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean#L90) — Output statement of a committed scalar phase: input statement, commitment, challenge.
...
- `theorem CheckClaim.oracleVerifier_toVerifier_run` [ArkLib/ProofSystem/Component/CheckClaim.lean:207](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L207) — The pure pass-through oracle verifier's underlying non-oracle verifier returns the combined input st
- `theorem ReduceClaim.oracleVerifier_toVerifier_run` [ArkLib/ProofSystem/Component/ReduceClaim.lean:376](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L376) — The `ReduceClaim` oracle verifier's underlying non-oracle verifier deterministically returns the map
...
- `theorem SendSingleWitness.oracleVerifier_toVerifier_run` [ArkLib/ProofSystem/Component/SendWitness.lean:302](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L302) — (no docstring)
...
### `oracleVerifier_coordinateWiseSpecialSound` (4 declarations, 4 files)

- `theorem CheckClaim.oracleVerifier_coordinateWiseSpecialSound` [ArkLib/ProofSystem/Component/CheckClaim.lean:240](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L240) — **Coordinate-wise special soundness of `CheckClaim`.** The verifier is a pure pass-through with no c
- `theorem ReduceClaim.oracleVerifier_coordinateWiseSpecialSound` [ArkLib/ProofSystem/Component/ReduceClaim.lean:395](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L395) — **Coordinate-wise special soundness of the `ReduceClaim` oracle reduction.** As in the non-oracle ca
- `theorem SendClaim.oracleVerifier_coordinateWiseSpecialSound` [ArkLib/ProofSystem/Component/SendClaim.lean:151](../../../ArkLib/ProofSystem/Component/SendClaim.lean#L151) — **Coordinate-wise special soundness of `SendClaim`.** The verifier is a pure pass-through with no ch
- `theorem SendSingleWitness.oracleVerifier_coordinateWiseSpecialSound` [ArkLib/ProofSystem/Component/SendWitness.lean:366](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L366) — **Coordinate-wise special soundness of `SendSingleWitness`.** The oracle verifier has no challenge r
...
- `theorem ReduceClaim.reduction_completeness` [ArkLib/ProofSystem/Component/ReduceClaim.lean:67](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L67) — The `ReduceClaim` reduction satisfies perfect completeness for any relation.
- `theorem SendWitness.reduction_completeness` [ArkLib/ProofSystem/Component/SendWitness.lean:96](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L96) — The `SendWitness` reduction satisfies perfect completeness.

### `relOut` (4 declarations, 4 files)

- `def ArkLib.Lattices.Ajtai.InnerOuter.relOut` [ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean:211](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean#L211) — **`relOut` — Hachi Eq. (20) (rows c1–c5 verbatim) plus a symmetric-`ℓ∞`-ball model of the `S_b` rang
...
- `def RingSwitching.QuotientEval.relOut` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:106](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L106) — The anchored output relation of the switch, from the committed-scalar shell: commitment consistency,
...
### `coordinateWiseSpecialSound` (4 declarations, 3 files)

- `def Verifier.coordinateWiseSpecialSound` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/Basic.lean:212](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/Basic.lean#L212) — A verifier is **coordinate-wise special sound** with respect to a coordinate-wise structure `D`, an 
- `def OracleVerifier.coordinateWiseSpecialSound` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/Basic.lean:234](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/Basic.lean#L234) — Coordinate-wise special soundness of an oracle reduction, defined (as for round-by-round notions) vi
- `theorem CoordinateWise.CommittedScalar.coordinateWiseSpecialSound` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean:231](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean#L231) — Generic CWSS theorem for committed scalar phases.  All protocol-independent extraction and tree reas
- `theorem RingSwitching.QuotientEval.coordinateWiseSpecialSound` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:177](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L177) — **CWSS of the quotient-evaluation switch**, at plain `k = 2d` special soundness, from the generic co
...
- `abbrev ArkLib.Lattices.Ajtai.InnerOuter.Message` [ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean:140](../../../ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean#L140) — Messages: block vectors over the message row space.
...
- `structure ArkLib.Lattices.Ajtai.InnerOuter.Opening` [ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean:116](../../../ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean#L116) — A Hachi/Greyhound *weak opening* `(sᵢ, t̂ᵢ, cᵢ)ᵢ`: the decomposition data `(sᵢ, t̂ᵢ)` (`Decomp`) ext
...
- `structure ArkLib.Lattices.Ajtai.InnerOuter.PublicParams` [ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean:95](../../../ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean#L95) — Public parameters: inner Ajtai matrix `A` and outer Ajtai matrix `B`.
...
### `buildWitness` (3 declarations, 3 files)

- `def ArkLib.Lattices.Ajtai.InnerOuter.buildWitness` [ArkLib/Commitments/Functional/Hachi/QuadEval/Soundness.lean:200](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Soundness.lean#L200) — The reduction's witness assembler (Hachi Lemma 8's three-case extraction) — the `mkWitness` argument
- `def CoordinateWise.CommittedScalar.buildWitness` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean:143](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean#L143) — Generic three-way assembler for a committed scalar phase. It passes through an existing escape, turn
- `def RingSwitching.QuotientEval.buildWitness` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:150](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L150) — The switch's extractor: the committed-scalar three-way assembler, projecting the common opening to i

### `commitmentScheme` (3 declarations, 3 files)

- `def ArkLib.Lattices.Ajtai.InnerOuter.commitmentScheme` [ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean:218](../../../ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean#L218) — The inner-outer Ajtai commitment as a `CommitmentScheme`, verified with the Hachi/Greyhound weak ver
...
- `def RingSwitching.SumcheckPhase.coreInteractionOracleReduction` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:511](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L511) — Large-field reduction: Sumcheck seqCompose, then append FinalSum
...
- `def RingSwitching.SumcheckPhase.coreInteractionOracleVerifier` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:502](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L502) — Large-field reduction verifier: Sumcheck seqCompose, then append FinalSum
...
- `def RingSwitching.SumcheckPhase.finalSumcheckKStateProp` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:409](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L409) — (no docstring)
...
- `def RingSwitching.SumcheckPhase.finalSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:439](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L439) — The knowledge state function for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckOracleReduction` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:356](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L356) — The oracle reduction for the final sumcheck step
...
- `theorem RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:370](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L370) — Perfect completeness for the final sumcheck step
...
- `theorem RingSwitching.SumcheckPhase.finalSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:458](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L458) — Round-by-round knowledge soundness for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckProver` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:293](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L293) — The prover for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:388](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L388) — The round-by-round extractor for the final sumcheck step
...
- `def RingSwitching.SumcheckPhase.finalSumcheckVerifier` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:337](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L337) — The verifier for the final sumcheck step, as an instance of the family-shared check-then-update one-
...
- `def RingSwitching.FullRingSwitching.fullOracleProof` [ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean:86](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean#L86) — The full DP24 ring-switching protocol as a Proof
...
- `def RingSwitching.FullRingSwitching.fullOracleReduction` [ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean:74](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean#L74) — The reduction for the full DP24 ring-switching protocol
...
- `theorem RingSwitching.FullRingSwitching.fullOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean:125](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean#L125) — (no docstring)
...
- `def RingSwitching.FullRingSwitching.fullOracleVerifier` [ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean:57](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean#L57) — The oracle verifier for the full DP24 ring-switching protocol

### `knowledgeStateFunction` (3 declarations, 3 files)

- `def CheckClaim.knowledgeStateFunction` [ArkLib/ProofSystem/Component/CheckClaim.lean:122](../../../ArkLib/ProofSystem/Component/CheckClaim.lean#L122) — The knowledge state function for the `CheckClaim` reduction, mirroring the trivial-verifier template
...
- `theorem ReduceClaim.oracleReduction_completeness` [ArkLib/ProofSystem/Component/ReduceClaim.lean:251](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L251) — The `ReduceClaim` oracle reduction satisfies perfect completeness for any relation. Proof strategy m
- `theorem SendSingleWitness.oracleReduction_completeness` [ArkLib/ProofSystem/Component/SendWitness.lean:340](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L340) — The `SendSingleWitness` oracle reduction satisfies perfect completeness.

### `relIn` (3 declarations, 3 files)

- `def ArkLib.Lattices.Ajtai.InnerOuter.relIn` [ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean:323](../../../ArkLib/Commitments/Functional/Hachi/QuadEval/Reduction.lean#L323) — **`relIn` — Hachi Lemma 8's extraction disjunction**: a weak `VerifiedOpening` for `u` that is also 
...
### `seqCompose_succ` (6 declarations, 2 files)

- `lemma Prover.seqCompose_succ` [ArkLib/OracleReduction/Composition/Sequential/General.lean:55](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L55) — (no docstring)
- `lemma Verifier.seqCompose_succ` [ArkLib/OracleReduction/Composition/Sequential/General.lean:89](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L89) — (no docstring)
- `lemma Reduction.seqCompose_succ` [ArkLib/OracleReduction/Composition/Sequential/General.lean:120](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L120) — (no docstring)
- `lemma OracleVerifier.seqCompose_succ` [ArkLib/OracleReduction/Composition/Sequential/General.lean:207](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L207) — (no docstring)
- `lemma OracleReduction.seqCompose_succ` [ArkLib/OracleReduction/Composition/Sequential/General.lean:277](../../../ArkLib/OracleReduction/Composition/Sequential/General.lean#L277) — (no docstring)
- `theorem ChallengeTreeShape.seqCompose_succ` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SeqCompose.lean:249](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SeqCompose.lean#L249) — **Successor unfolding of the sequentially-composed shape.** `ChallengeTreeShape.seqCompose` of a fam
...
- `instance SendWitness.instIsEmptyChallengeIdx` [ArkLib/ProofSystem/Component/SendWitness.lean:58](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L58) — The `SendWitness` protocol is a single `P_to_V` message, so it has no challenge rounds. This is what
- `instance SendSingleWitness.instIsEmptyChallengeIdx` [ArkLib/ProofSystem/Component/SendWitness.lean:247](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L247) — The `SendSingleWitness` protocol is a single `P_to_V` message, so it has no challenge rounds. This i
...
- `abbrev ArkLib.Lattices.Ajtai.InnerOuter.Commitment` [ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean:144](../../../ArkLib/Commitments/Functional/Hachi/InnerOuter/Scheme.lean#L144) — Inner-outer commitments live in the outer row space.
...
- `abbrev ArkLib.Lattices.Ajtai.InnerOuter.LiftedWitness` [ArkLib/Commitments/Functional/Hachi/RingSwitch/Reduction.lean:93](../../../ArkLib/Commitments/Functional/Hachi/RingSwitch/Reduction.lean#L93) — Hachi Eq. (21)'s lifted witness: the `R^lin` witness `z ∈ Rq^μ` and one quotient polynomial per row 
- `structure RingSwitching.QuotientEval.LiftedWitness` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:57](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L57) — The lifted witness of the quotient-evaluation switch: the `S`-witness `z` of the linear relation and
...
- `abbrev RingSwitching.SumcheckWitness` [ArkLib/ProofSystem/RingSwitching/TensorPacking/Prelude.lean:219](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/Prelude.lean#L219) — (no docstring)
...
- `def RingSwitching.FullRingSwitching.batchingCoreReduction` [ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean:64](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean#L64) — (no docstring)
...
- `def RingSwitching.FullRingSwitching.batchingCoreVerifier` [ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean:48](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean#L48) — (no docstring)
...
- `def CoordinateWise.ScalarRound.branchPath` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:207](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L207) — The root-to-leaf path through `tree2` selecting branch `j` of the challenge node.
- `def CoordinateWise.SingleRound.branchPath` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:187](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L187) — The root-to-leaf path through `tree2` selecting branch `j` of the challenge node. Defined separately

### `branchTr` (2 declarations, 2 files)

- `def CoordinateWise.ScalarRound.branchTr` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:214](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L214) — The full transcript of branch `j` of the star tree: message `v`, challenge `challenges j`.
- `def CoordinateWise.SingleRound.branchTr` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:194](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L194) — The full transcript of branch `j` of the star tree: message `v`, challenge `challenges j`.

### `branch_challenge` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.branch_challenge` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:220](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L220) — Branch `j`'s transcript carries challenge `challenges j` at round 1.
- `theorem CoordinateWise.SingleRound.branch_challenge` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:200](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L200) — Branch `j`'s transcript carries challenge `challenges j` at round 1.

### `branch_mem` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.branch_mem` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:238](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L238) — Branch `j`'s transcript is one of the star tree's leaf transcripts.
- `theorem CoordinateWise.SingleRound.branch_mem` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:218](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L218) — Branch `j`'s transcript is one of the star tree's leaf transcripts.

### `branch_pre` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.branch_pre` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:229](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L229) — Branch `j`'s transcript carries the shared message `v` at round 0.
- `theorem CoordinateWise.SingleRound.branch_pre` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:209](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L209) — Branch `j`'s transcript carries the shared message `v` at round 0.

### `branch_relOut_language` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.branch_relOut_language` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:295](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L295) — Acceptance of the star tree specializes, per branch `j`, to membership of the branch's verifier outp
- `theorem CoordinateWise.SingleRound.branch_relOut_language` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:322](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L322) — Acceptance of the star tree specializes, per branch `j`, to membership of the branch's verifier outp

### `buildWitness_mem` (2 declarations, 2 files)

- `theorem CoordinateWise.CommittedScalar.buildWitness_mem` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean:163](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean#L163) — Correctness of `buildWitness`, parameterized by the only construction-specific fact: one common shor
- `theorem RingSwitching.QuotientEval.buildWitness_mem` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:158](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L158) — Correctness of the extractor against the input relation.

### `chal_shape` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.chal_shape` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:166](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L166) — Shape recovery, level 1: every subtree at round 1 is a `chalNode` over leaves.
- `theorem CoordinateWise.SingleRound.chal_shape` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:141](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L141) — Shape recovery, level 1: every subtree at round 1 is a `chalNode` over leaves.

### `chalsAux` (2 declarations, 2 files)

- `def CoordinateWise.ScalarRound.chalsAux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:109](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L109) — Index-generic round-1 reader: peel the sibling-challenge family off a `chalNode` at any index `a` to
- `def CoordinateWise.SingleRound.chalsAux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:84](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L84) — Index-generic round-1 reader: peel the sibling-challenge family off a `chalNode` at any index `a` to
...
- `theorem CoordinateWise.ScalarRound.eq_leaf` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:156](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L156) — Shape recovery, level 2: every subtree at the last round is a leaf.
- `theorem CoordinateWise.SingleRound.eq_leaf` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:131](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L131) — Shape recovery, level 2: every subtree at the last round is a leaf.
...
- `theorem RingSwitching.FullRingSwitching.fullOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean:151](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean#L151) — Round-by-round knowledge soundness for the full ring-switching oracle verifier
...
- `def RingSwitching.fullPspec` [ArkLib/ProofSystem/RingSwitching/TensorPacking/Spec.lean:82](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/Spec.lean#L82) — (no docstring)
...
- `def RingSwitching.FullRingSwitching.fullRbrKnowledgeError` [ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean:143](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/General.lean#L143) — (no docstring)
...
- `def RingSwitching.masterKStateProp` [ArkLib/ProofSystem/RingSwitching/TensorPacking/Prelude.lean:418](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/Prelude.lean#L418) — (no docstring)
...
- `def RingSwitching.pSpecCoreInteraction` [ArkLib/ProofSystem/RingSwitching/TensorPacking/Spec.lean:75](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/Spec.lean#L75) — (no docstring)
...
- `abbrev RingSwitching.pSpecSumcheckRound` [ArkLib/ProofSystem/RingSwitching/TensorPacking/Spec.lean:55](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/Spec.lean#L55) — (no docstring)
...
- `def CoordinateWise.CommittedScalar.package` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean:248](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/CommittedScalar.lean#L248) — Bundled committed scalar phase, ready for CWSS composition.
- `def RingSwitching.QuotientEval.package` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:194](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L194) — The quotient-evaluation switch as a composable CWSS package.
...
- `def CoordinateWise.ScalarRound.readChallenges` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:121](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L121) — Read the round-1 sibling-challenge family off a full tree: a two-level peel — the round-0 helper str
- `def CoordinateWise.SingleRound.readChallenges` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:96](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L96) — Read the round-1 sibling-challenge family off a full tree: a two-level peel — the round-0 helper str

### `readChallenges_tree2` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.readChallenges_tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:151](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L151) — The round-1 reader computes on the star tree.
- `theorem CoordinateWise.SingleRound.readChallenges_tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:126](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L126) — The round-1 reader computes on the star tree.

### `readPre` (2 declarations, 2 files)

- `def CoordinateWise.ScalarRound.readPre` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:103](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L103) — Read the round-0 message (the pre-challenge commitment) off a full tree.
- `def CoordinateWise.SingleRound.readPre` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:77](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L77) — Read the round-0 message (the pre-challenge carrier commitment) off a full tree.

### `readPre_tree2` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.readPre_tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:146](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L146) — The round-0 reader computes on the star tree.
- `theorem CoordinateWise.SingleRound.readPre_tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:121](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L121) — The round-0 reader computes on the star tree.
...
### `relOutE` (2 declarations, 2 files)

- `def ArkLib.Lattices.Ajtai.InnerOuter.relOutE` [ArkLib/Commitments/Functional/Hachi/Escape.lean:72](../../../ArkLib/Commitments/Functional/Hachi/Escape.lean#L72) — Escape-threaded `QuadEval.relOut` (Hachi Eq. (20) + range checks, widened): the §4.3 chain's input s
- `def RingSwitching.QuotientEval.relOutE` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:110](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L110) — Escape-threaded output relation.
...
- `abbrev RingSwitching.SumcheckPhase.roundKnowledgeError` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:153](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L153) — (no docstring)
...
- `def SendSingleWitness.toORelOut` [ArkLib/ProofSystem/Component/SendWitness.lean:333](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L333) — (no docstring)
...
- `def ReedSolomon.toPolynomial` [ArkLib/Data/CodingTheory/ReedSolomon.lean:586](../../../ArkLib/Data/CodingTheory/ReedSolomon.lean#L586) — The linear map that maps a Reed-Solomon codeword to its associated polynomial.

### `topMsgAux` (2 declarations, 2 files)

- `def CoordinateWise.ScalarRound.topMsgAux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:92](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L92) — Index-generic round-0 message reader: peel the top `msgNode` of a tree at any index `a` together wit
- `def CoordinateWise.SingleRound.topMsgAux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:66](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L66) — Index-generic round-0 message reader: peel the top `msgNode` of a tree at any index `a` together wit

### `tree2` (2 declarations, 2 files)

- `def CoordinateWise.ScalarRound.tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:140](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L140) — The star tree: one message node carrying `v`, one challenge node carrying the sibling family, leaves
- `def CoordinateWise.SingleRound.tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:115](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L115) — The star tree: one message node carrying `v`, one challenge node carrying the sibling family, leaves

### `treeExtractor` (2 declarations, 2 files)

- `def CoordinateWise.ScalarRound.treeExtractor` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:318](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L318) — The scalar tree extractor, generic over separate witness types: `relOut` relates the extended statem
- `def CoordinateWise.SingleRound.treeExtractor` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:345](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L345) — The tree extractor, generic over separate witness types: `relOut` relates the extended statement to 

### `tree_shape` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.tree_shape` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:199](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L199) — **Shape recovery.** Every full tree of the two-round scalar `pSpec` is a star tree.
- `theorem CoordinateWise.SingleRound.tree_shape` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:177](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L177) — **Shape recovery.** Every full tree of the two-round `pSpec` is a star tree. This is the rewrite tha

### `tree_shape_aux` (2 declarations, 2 files)

- `theorem CoordinateWise.ScalarRound.tree_shape_aux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:184](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L184) — Shape recovery, level 0: every tree at round 0 is a `tree2`.
- `theorem CoordinateWise.SingleRound.tree_shape_aux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:159](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L159) — Shape recovery, level 0: every tree at round 0 is a `tree2`.
...
### `verifier_coordinateWiseSpecialSound` (2 declarations, 2 files)

- `theorem ReduceClaim.verifier_coordinateWiseSpecialSound` [ArkLib/ProofSystem/Component/ReduceClaim.lean:186](../../../ArkLib/ProofSystem/Component/ReduceClaim.lean#L186) — **Coordinate-wise special soundness of `ReduceClaim`.** The verifier is pure with no challenge round
- `theorem SendWitness.verifier_coordinateWiseSpecialSound` [ArkLib/ProofSystem/Component/SendWitness.lean:109](../../../ArkLib/ProofSystem/Component/SendWitness.lean#L109) — **Coordinate-wise special soundness of `SendWitness`.** The verifier has no challenge rounds, so CWS
...
- `def RingSwitching.witnessStructuralInvariant` [ArkLib/ProofSystem/RingSwitching/TensorPacking/Prelude.lean:409](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/Prelude.lean#L409) — This condition ensures that the witness polynomial `H` has the correct structure `A(...) * t'(...)`

## Near-duplicate docstrings (Jaccard ≥ 0.85, 72 cross-file pairs)
...
- **1.00** `ArkLib.Lattices.Ajtai.InnerOuter.liftProver` [ArkLib/Commitments/Functional/Hachi/RingSwitch/Reduction.lean:159](../../../ArkLib/Commitments/Functional/Hachi/RingSwitch/Reduction.lean#L159) vs `RingSwitching.QuotientEval.prover` [ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean:125](../../../ArkLib/ProofSystem/RingSwitching/QuotientEval/Reduction.lean#L125)
    - a: Honest prover shell.  Its commitment is definitionally derived from the output opening.
    - b: Honest prover shell. Its commitment is definitionally derived from the output opening.
- **1.00** `Binius.BinaryBasefold.CoreInteraction.commitKState` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:619](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L619) vs `RingSwitching.SumcheckPhase.iteratedSumcheckKnowledgeStateFunction` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:238](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L238)
    - a: Knowledge state function (KState) for single round
    - b: Knowledge state function (KState) for single round
- **1.00** `Binius.BinaryBasefold.CoreInteraction.commitOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:639](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L639) vs `RingSwitching.SumcheckPhase.iteratedSumcheckOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:274](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L274)
...
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:960](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L960) vs `RingSwitching.SumcheckPhase.finalSumcheckOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:370](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L370)
    - a: Perfect completeness for the final sumcheck step
    - b: Perfect completeness for the final sumcheck step
...
- **1.00** `Binius.BinaryBasefold.CoreInteraction.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean:987](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/Steps.lean#L987) vs `RingSwitching.SumcheckPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:388](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L388)
    - a: The round-by-round extractor for the final sumcheck step
    - b: The round-by-round extractor for the final sumcheck step
...
- **1.00** `Binius.FRIBinius.CoreInteractionPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:505](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L505) vs `RingSwitching.SumcheckPhase.finalSumcheckRbrExtractor` [ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean:388](../../../ArkLib/ProofSystem/RingSwitching/TensorPacking/SumcheckPhase.lean#L388)
    - a: The round-by-round extractor for the final sumcheck step
    - b: The round-by-round extractor for the final sumcheck step
- **1.00** `CoordinateWise.ScalarRound.branch_mem` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:238](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L238) vs `CoordinateWise.SingleRound.branch_mem` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:218](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L218)
...
- **1.00** `CoordinateWise.ScalarRound.branch_pre` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:229](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L229) vs `CoordinateWise.SingleRound.branch_pre` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:209](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L209)
...
- **1.00** `CoordinateWise.ScalarRound.branch_relOut_language` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:295](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L295) vs `CoordinateWise.SingleRound.branch_relOut_language` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:322](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L322)
...
- **1.00** `CoordinateWise.ScalarRound.chal_shape` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:166](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L166) vs `CoordinateWise.SingleRound.chal_shape` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:141](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L141)
...
- **1.00** `CoordinateWise.ScalarRound.eq_leaf` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:156](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L156) vs `CoordinateWise.SingleRound.eq_leaf` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:131](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L131)
...
- **1.00** `CoordinateWise.ScalarRound.readChallenges` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:121](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L121) vs `CoordinateWise.SingleRound.readChallenges` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:96](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L96)
...
- **1.00** `CoordinateWise.ScalarRound.readChallenges_tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:151](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L151) vs `CoordinateWise.SingleRound.readChallenges_tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:126](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L126)
    - a: The round-1 reader computes on the star tree.
    - b: The round-1 reader computes on the star tree.
- **1.00** `CoordinateWise.ScalarRound.readPre_tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:146](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L146) vs `CoordinateWise.SingleRound.readPre_tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:121](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L121)
    - a: The round-0 reader computes on the star tree.
    - b: The round-0 reader computes on the star tree.
- **1.00** `CoordinateWise.ScalarRound.topMsgAux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:92](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L92) vs `CoordinateWise.SingleRound.topMsgAux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:66](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L66)
...
- **1.00** `CoordinateWise.ScalarRound.tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:140](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L140) vs `CoordinateWise.SingleRound.tree2` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:115](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L115)
...
- **1.00** `CoordinateWise.ScalarRound.tree_shape_aux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:184](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L184) vs `CoordinateWise.SingleRound.tree_shape_aux` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:159](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L159)
...
- **0.91** `CoordinateWise.ScalarRound.treeExtractor` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:318](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L318) vs `CoordinateWise.SingleRound.treeExtractor` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:345](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L345)
    - a: The scalar tree extractor, generic over separate witness types: `relOut` relates the extended statem
    - b: The tree extractor, generic over separate witness types: `relOut` relates the extended statement to 
- **0.88** `CoordinateWise.ScalarRound.readPre` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean:103](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/ScalarRound.lean#L103) vs `CoordinateWise.SingleRound.readPre` [ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean:77](../../../ArkLib/OracleReduction/Security/CoordinateWiseSpecialSoundness/SingleRound.lean#L77)
    - a: Read the round-0 message (the pre-challenge commitment) off a full tree.
    - b: Read the round-0 message (the pre-challenge carrier commitment) off a full tree.
