...
- `ArkLib` — 365 files, 5863 declarations
...
- `def Code.agree` [ArkLib/Data/CodingTheory/Basic/Distance.lean:219](../../../ArkLib/Data/CodingTheory/Basic/Distance.lean#L219) — The number of positions at which the two words `u` and `v` agree.
