...
- The affine-line exact-transfer corollary is present as the externally admitted
  `ProximityGap.mcaError_affineLine_interleaved_eq`, stated directly on `mcaError` with the
  source's nonempty-interleaving and open-radius guards.
