...
| Theorem 4.14 folded RS MCA up to capacity | missing | prerequisites `ReedSolomon.Folded.frsCode` and `CodingTheory.frs_is_subspaceDesign_gk16` | The folded-RS code and FRS half of T2.18 are present; the MCA theorem is missing. |
