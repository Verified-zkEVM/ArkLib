...
## `ArkLib/ToMathlib/LinearAlgebra/FiniteDimensional.lean`

`LinearMap.finrank_range_pi_le` and `LinearMap.exists_ne_zero_map_eq_zero_of_finrank_range_lt`
are the linear algebra inside `finrank_firstOrderGlobalConstraint_le` and
`exists_nonzero_firstOrder_interpolant` of
`ArkLib/Data/CodingTheory/ReedSolomon/HiddenDerivative/Interpolation/FirstOrder/Interpolation.lean`
at ArkLib revision `a5aa2677fee4e3a79d6bb05136631cce4a08587d`, over a division ring.
