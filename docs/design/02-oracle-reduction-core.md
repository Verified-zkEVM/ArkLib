...
**Normative.** The Δ-side design: what an oracle reduction is, what its output claim is, how claims close and compose. Supersedes the round-3 document's §§0–6.8 with the round-4 repairs applied; full history in [`archive/`](archive/).
