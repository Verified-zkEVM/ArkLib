...
/-!
  ...
  The loop `roundsChain` composes the rounds by recursion over the binary guarded append,
  with `roundsChain_relIn` / `roundsChain_relOut` pinning the input and output relations.
