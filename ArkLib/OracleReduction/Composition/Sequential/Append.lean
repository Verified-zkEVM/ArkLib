...
lemma OracleVerifier.append_toVerifier
  ...
  simp only [MessageIdx, Message, OptionT.run_bind, Option.elimM, map_bind,
    OptionT.mk_bind, OptionT.run_monadLift, monadLift_self,
    ProgrammingPolicy.empty_apply, OptionT.run_mk, bind_map_left,
    Option.elim_some, Option.elim_map, Function.comp_def]
  rw [show
