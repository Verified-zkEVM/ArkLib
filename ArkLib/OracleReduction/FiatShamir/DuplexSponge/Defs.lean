...
public import ArkLib.OracleReduction.Security.OracleSampling
...
at call sites in §5.8 hybrids and the future Lemma 5.8 eager `𝒟_Σ` experiment.
...
Used uniformly in §5.4 (`D2SAlgo` input), §5.6's future Lemma 5.8 experiments, and the
§5.8 hybrids `Hyb_0 .. Hyb_4`. -/
