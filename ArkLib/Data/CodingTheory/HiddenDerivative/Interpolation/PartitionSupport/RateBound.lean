...
The ambient rate lower bound and the block length bound the total jet degree of every eligible
partition-support exponent by the rate-dependent jet cap.
